...
if ($like) {
    ...
    $mysqli->query("UPDATE blog SET likes = likes-1 WHERE id = " . $_SESSION["story"]);
} else {
    $mysqli->query("INSERT INTO liked (user_id, blog_id) 
    ...
    if ($dislike) {
        ...
        $mysqli->query("UPDATE blog SET likes = likes+1, dislikes = dislikes-1 WHERE id = " . $_SESSION["story"]);
    } else $mysqli->query("UPDATE blog SET likes = likes+1 WHERE id = " . $_SESSION["story"]);
